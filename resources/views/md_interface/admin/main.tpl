...
<head>
    ...
    <!-- Bootstrap 3.3.2 -->
    <link href="{if $CDNType}{$CDNDomain}{else}..{/if}/assets/public/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <!-- Font Awesome Icons -->
    ...
    <!-- Theme style -->
    <link href="{if $CDNType}{$CDNDomain}{else}..{/if}/assets/public/css/AdminLTE.min.css" rel="stylesheet" type="text/css"/>
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link href="{if $CDNType}{$CDNDomain}{else}..{/if}/assets/public/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css"/>

    <!-- jQuery 2.1.3 -->
    <script src="{if $CDNType}{$CDNDomain}{else}..{/if}/assets/public/js/jquery.min.js"></script>
